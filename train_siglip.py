...
from losses import siglip_loss
from settings import MODEL_DATA_SIGLIP
from utils import *
import open_clip
...
def train(config, reload=False):
    ...
    save_path = os.path.join(MODEL_DATA_SIGLIP, save_path)
    ...
    tokenizer = open_clip.get_tokenizer(Model["backbone"])
    ...
    for epoch in range(epochs):
        ...
        for images, labels in pbar:
            ...
            if loss_function == "siglip":
                loss = siglip_loss(logits, labels.to(device))
